...
const LIGHT_THEMES: Dictionary = {
	"adwaita_lighter": {
		"label": "Light",
		"variant": "light",
		"bg_black":   "#E5E5EA", "bg_darker":  "#EFEFF4", "bg_surface": "#F6F6F8",
		"bg_card":    "#FFFFFF", "bg_lighter": "#FFFFFF",
		"fg":         "#111113", "fg_bright":  "#000000", "muted":      "#6C6C70",
		"blue":       "#0066CC", "green":      "#16a34a", "cyan":       "#0284c7", "red": "#d73a49",
		"hl_number":  "#d97706", "hl_symbol":  "#6c6c70", "hl_func":    "#0066cc",
		"hl_member":  "#0284c7", "hl_comment": "#6c6c70", "hl_string":  "#16a34a",
		"hl_keyword": "#0066cc", "hl_type":    "#0284c7", "hl_const":   "#d97706",
	},
	"monokai_light": {
		"label": "Monokai Light",
		"variant": "light",
