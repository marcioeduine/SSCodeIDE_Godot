...
const DARK_THEMES: Dictionary = {
	"adwaita_darker": {
		...
		"variant": "dark",
		"bg_black":   "#0c0c0e", "bg_darker":  "#131316", "bg_surface": "#18181c",
		"bg_card":    "#222228", "bg_lighter": "#2c2c34",
		"fg":         "#dfdfe6", "fg_bright":  "#ffffff", "muted":      "#848494",
...
const LIGHT_THEMES: Dictionary = {
	"adwaita_lighter": {
		...
		"variant": "light",
		"bg_black":   "#ffffff", "bg_darker":  "#f7f8fa", "bg_surface": "#f2f3f5",
		"bg_card":    "#ebecf0", "bg_lighter": "#dfe1e5",
		"fg":         "#000000", "fg_bright":  "#000000", "muted":      "#797979",
		"blue":       "#2958e5", "green":      "#147a26", "cyan":       "#0d6277", "red": "#cf222e",
		"hl_number":  "#173cad", "hl_symbol":  "#000000", "hl_func":    "#2958e5",
		"hl_member":  "#660e7a", "hl_comment": "#8c8c8c", "hl_string":  "#067d17",
		"hl_keyword": "#0033b3", "hl_type":    "#000000", "hl_const":   "#871094",
	},
	"monokai_light": {
		"label": "Monokai Light",
		"variant": "light",
